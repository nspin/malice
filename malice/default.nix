...
, malice-core-attoparsec, malice-core-instances-logger
, malice-core-serialize, memory, monad-logger, monad-unlift, mtl
, network, optparse-applicative, pcap, pem, socks, stdenv, text
, tls, transformers, x509, x509-store, x509-validation
}:
mkDerivation {
  pname = "malice";
  version = "0.1.0.0";
  ...
  libraryHaskellDepends = [
    ...
    malice-core-attoparsec malice-core-instances-logger
    malice-core-serialize memory monad-logger monad-unlift mtl network
    pcap socks text tls transformers x509 x509-store x509-validation
  ];
  executableHaskellDepends = [
    ...
    http-types JuicyPixels JuicyPixels-extra lens malice-core
    malice-core-attoparsec malice-core-instances-logger memory
